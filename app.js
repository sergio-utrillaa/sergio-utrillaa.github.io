const preguntes = {
    tema0:[
        ...
        {
            "pregunta": "Quin és un tipus sistema d’informació operational?",
        ...
        {
            "pregunta": "Quin tipus de sistema d’informació utilitza accedeix dades atòmiques?",
            "opcions": ["Operational", "Decisional"],
            "correcta": 0
        },
        {
        ...
        {
            "pregunta": "Per a quin tipus de sistemes d’informació es rellevant el seu rendiment (performance)?",
        ...
        },
        {
            ...
            "opcions": ["Problemes", "Funcionalitats", "Estats", "Temes"],
            "correcta": 3
        },
        {
            "pregunta": "Quin NO és una de les tres fases principals del disseny de bases de dades?",
            "opcions": ["Lògic", "Captura de requisits", "Físic", "Conceptual"],
            "correcta": 1
        },
        {
        ...
        },
        {
            ...
            "opcions": ["Diagrames de seqüència", "Diagrama de classes", "Casos d’us", "Diagrama d’estats"],
            "correcta": 1
        },
        {
            "pregunta": "En que es basa el disseny de la base de dades?",
            "opcions": ["Només amb les dades", "Només amb els processos", "En les dues coses", "En cap de les dues coses"],
            "correcta": 2
        },
        {
            "pregunta": "És fonamental que l’esquema lògic l’entenguin els usuaris del sistema.",
            "opcions": ["Cert", "Fals"],
            "correcta": 1
        },
        {
    ...
    tema1:[
      ...
      },
      {
          ...
          "opcions": ["Automàtica", "Integració de vistes", "Manual", "Definició de procediments"],
          "correcta": 3
      },
      {
          ...
          "opcions": [
              ...
              "Consideracions respecte a temps de resposta, concurrència, recuperació y seguretat", 
      ...
      },
      {
          ...
          "opcions": [
              "Dos atributs que representen el mateix valor, però en unitats de mesura diferentes", 
              "Dues classes del mateix concepte, però amb noms diferentes", 
              "Dues taules amb dades equivalents, però amb noms diferentes", 
              "Dos procediments emmagatzemats que fan el mateix, però en llenguatges de programació diferentes"
          ],
          "correcta": 3
      },
      {
          "pregunta": "Un atribut d'una classe, es pot representar també mitjan¸cant una associació d'aquesta amb una segona classe.",
          "opcions": ["Cert", "Fals"],
          "correcta": 0
      },
      {
      ...
      {
          "pregunta": "El valor null és un dels del domini de l'atribut.",
          "opcions": ["Cert", "Fals"],
          "correcta": 1
      },
      {
      ...
      {
          "pregunta": "¿En quin cas NO s'haurien d'utilitzar valor nulls?",
          "opcions": [
      ...
      {
          "pregunta": "¿Quina afirmació es certa?",
          "opcions": [
              "El valor null dividit per zero dona error", 
              "Un null igualat amb ell mateix (\"NULL=NULL\") avalua cert", 
              "Un valor null ocupa el mateix espai que qualsevol altra valor", 
      ...
      {
          "pregunta": "Si com a resultat d'una operació algebraica de projecció queda més d'una fila que només te valor null a tots els seus atributs, a la sortida apareixerà aquesta fila tantes vegades com la tingues a l'entrada.",
          "opcions": ["Cert", "Fals"],
          "correcta": 1
      },
      {
          "pregunta": "¿Quina de les següents expressions dona error en SQL estàndard?",
          "opcions": ["0/NULL", "NULL/0", "NULL/NULL", "Cap d'elles dona error"],
          "correcta": 3
      },
      {
          "pregunta": "El GROUP BY genera un grup per a cada valor null que trova.",
          "opcions": ["Cert", "Fals"],
          "correcta": 1
      },
      {
      ...
      },
      {
          ...
          "opcions": ["Disjoint", "Complete", "Overlapping", "Imbalanced"],
          "correcta": 3
      },
      {
      ...
      {
          "pregunta": "¿Quina de les tres implementacions de Generalització/Especializació NO genera mai nuls ni repeteix valors?",
          "opcions": [
              ...
              "Cap de les tres, totes podem generar problemes depenent del tipus de Generalització/Especialització"
          ],
          "correcta": 1
      },
      {
      ...
      {
          "pregunta": "Quan implementem una Generalització/Especializació en un SGBD relacional, sempre cal util·litzar una outer join per consultar juntes totes les dades de qualsevol de les subclasses.",
          "opcions": ["Cert", "Fals"],
          "correcta": 1
      },
      {
          "pregunta": "¿Quin dels tres tipus de join NO genera mai valors null?",
          "opcions": ["Full outer join", "Right outer join", "Left outer join", "Tots tres en podem generar"],
          "correcta": 3
      },
      {
      ...
      },
      {
          ...
          "opcions": [
              ...
              "Podem inserir dades indistintament a qualsevol de les dues taules i tindrem de mateix resultat", 
              "Podem inserir dades a qualsevol de les dues taules, però no tindrem del mateix resultat"
          ],
          "correcta": 3
      },
      {
          ...
          "opcions": [
              ...
              "El atributs de la clau externa canvien molt sovint", 
      ...
      {
          "pregunta": "Una SEQUENCE de PostgreSQL es pot utilitzar a taules diferentes.",
          "opcions": ["Cert", "Fals"],
          "correcta": 0
      }
  ],
    tema2:[
      ...
      {
          "pregunta": "¿Quin tipus d'associació binària s'ha d'implementar sempre amb una taula propia (a més de les dues corresponents a les classes)?",
      ...
      },
      {
          ...
          "opcions": [
              "Freqüència d'us a les consultes", 
              "Freqüència de canvi", 
              "Espai requerit", 
              "Nombre de dependencies funcionals"
          ],
          "correcta": 3
      },
      {
          ...
          "opcions": [
              "Podem ser simètriques o no", 
              "Podem generar cadenes amb infinites instàncies", 
      ...
      {
          "pregunta": "En una aggregació composta, tots dos costats poden tenir un zero.",
          "opcions": ["Cert", "Fals"],
          "correcta": 1
      },
      {
      ...
      {
          "pregunta": "Una associació dona lloc realment a una classe associativa quan ...",
          "opcions": [
              "Té molts atributs", 
      ...
      {
          "pregunta": "Quan un atribut multivaluat pot tenir molts valors, es millor emmagatzemar-ho per columnes.",
          "opcions": ["Cert", "Fals"],
          "correcta": 1
      },
      {
    ...
    tema3: [
      ...
      },
      {
          ...
          "opcions": [
              "Algunes dades es podem perdre sense voler", 
      ...
      {
          "pregunta": "Una clau primària correspon a ...",
          "opcions": [
      ...
      {
          "pregunta": "Una clau primària i un altre atribut de la mateixa relació podem estar relacionats amb ...",
          "opcions": [
              "una funció injectiva",
              "una funció bijectiva", 
              "una funció exhaustiva",
      ...
      {
          "pregunta": "La BCNF es va definir perquè 2NF i 3NF no garantitzen l'absència d'anomalies.",
          "opcions": ["Cert", "Fals"],
          "correcta": 0
      },
      {
      ...
      {
          "pregunta": "Amb l'algorisme de normalització d'anàlisi es poden perdre dependencies funcionals.",
          "opcions": ["Cert", "Fals"],
          "correcta": 0
      },
      {
      ...
      {
          "pregunta": "No tots els casos es podem normalitzar fins a BCNF.",
          "opcions": ["Cert", "Fals"],
          "correcta": 1
      },
      {
          "pregunta": "Donades les dependencies funcionals, la normalización es pot automatitzar totalment.",
          "opcions": ["Cert", "Fals"],
          "correcta": 0
      },
      {
          "pregunta": "Un esquema normalitzat és millor que un que no ho està, perquè el primer conté redundancies que el segon no té.",
          "opcions": ["Cert", "Fals"],
          "correcta": 1
      },
      {
    ...
    tema4: [
      ...
      {
          "pregunta": "¿Quin tipus de sistema té un us més repetitiu?",
          "opcions": [
              "Operacional",
              "Decisional", 
              "Els dos similar"
      ...
      {
          "pregunta": "¿En quin tipus de sistema una consulta acostuma a accedir més tuples?",
          "opcions": [
              "Operacional",
              "Decisional", 
              "Els dos similar"
      ...
      {
          "pregunta": "¿Quin tipus de sistema té més dades históriques?",
          "opcions": [
              "Operacional",
              "Decisional", 
              "Els dos similar"
      ...
      {
          "pregunta": "¿Quina diferència hi ha entre una arquitectura d'un sol nivell i una de dos d'emmagatzemament de dades?",
          "opcions": [
      ...
      {
          "pregunta": "Una arquitectura d'un sol nivell d'emmagatzemament de dades, genera un magatzem de dades virtual.",
          "opcions": ["Cert", "Fals"],
          "correcta": 0
      },
      {
          "pregunta": "En una arquitectura de dos nivells d'emmagatzemament de dades, les dades es podem replicar com a màxim dues vegades.",
          "opcions": ["Cert", "Fals"],
          "correcta": 1
      },
      {
      ...
      },
      {
          ...
          "opcions": [
              ...
              "No permeten operacions d'àlgebra linial", 
      ...
      {
          "pregunta": "Un cub de dades es una metàfora per a una taula estadística.",
          "opcions": ["Cert", "Fals"],
          "correcta": 0
      },
      {
      ...
      {
          "pregunta": "¿Quants atributs te la claus primària de la taula de fets d'un esquema en estrella?",
          "opcions": [
              "Un",
      ...
      {
          "pregunta": "Sempre que es pugui, es millor utilitzar ROLLUP i/o CUBE, en lloc de GROUPING SETS, perquè facilita l'optimització de la consulta.",
          "opcions": ["Cert", "Fals"],
          "correcta": 0
      }
  ],
    tema5:[
      {
          "pregunta": "Els SGBDs relationals permeten implementar qualsevol tipus de sistema d'informació de forma eficient.",
          "opcions": ["Cert", "Fals"],
          "correcta": 1
      },
      {
      ...
      {
          "pregunta": "Els sistemes NOSQL garanteixes les restriccions d'integritat, tal com fan els sistemes relacionals.",
          "opcions": ["Cert", "Fals"],
          "correcta": 1
      },
      {
      ...
      {
          "pregunta": "La independència física, d'acord amb l'arquitectura ANSI/SPARC, garanteix que un canvi en l'esquema intern no afectara a les taules de la base de dades.",
          "opcions": ["Cert", "Fals"],
          "correcta": 0
      },
      {
          "pregunta": "La independència lògica, d'acord amb l'arquitectura ANSI/SPARC, garanteix que un canvi en les vistes no afectara a les taules de la base de dades.",
          "opcions": ["Cert", "Fals"],
          "correcta": 0
      },
      {
          "pregunta": "La independència lògica, d’acord amb l’arquitectura ANSI/SPARC, garanteix que un canvi en una taula no afectara a cap vista de la base de dades, tret que el canvi afecti els atributs o taules utilitzats en la vista.",
          "opcions": ["Cert", "Fals"],
          "correcta": 0
      },
      {
          "pregunta": "Una SGBD relacional pot contenir una base de dades que segueixi a la vegada el model relacional i corelacional.",
          "opcions": ["Cert", "Fals"],
          "correcta": 0
      },
      {
      ...
      {
          "pregunta": "Un atribut multivaluat guardat en un array generarà tans accessos a disc com elements tingui l'array.",
          "opcions": ["Cert", "Fals"],
          "correcta": 1
      },
      {
    ...
    tema6: [
      {
          ...
          "opcions": ["Lògic", "External", "Conceptual", "Internal"],
          "correcta": 0
      },
      {
      ...
      {
          "pregunta": "La consulta que definiex una vista sempre està guardada al catàleg de la base de dades.",
          "opcions": ["Cert", "Fals"],
          "correcta": 0
      },
      {
      ...
      },
      {
          ...
          "opcions": ["Query rewriting", "Update through views", "View expansion", "View updating", "View materialization"],
          "correcta": 4
      },
      {
      ...
      {
          "pregunta": "¿Quants dels tres problemes teòrics que tenen associats a les vistes materialitzades podem veure explícitament reflectits a la seva sentencia de creació d'Oracle?",
      ...
      {
          "pregunta": "Update Through Views consisteix a utilitzar les vistes en comptes dels índexs per accedir més rapid a les dades quan les hem de modificar.",
          "opcions": ["Cert", "Fals"],
          "correcta": 1
      },
      {
      ...
      {
          "pregunta": "Els SGBDs permeten modificar una taula a través d'una vista definida sobre una altra vista si les dues definicions de les vistes compleixen, per separat, les condicions necessaries.",
          "opcions": ["Cert", "Fals"],
          "correcta": 0
      },
      {
      ...
      },
      {
          ...
          "opcions": ["Next <date>", "On statement", "On commit", "On demand", "Podem propagar-los de totes les maneres anteriors"],
          "correcta": 4
      },
      {
      ...
      },
      {
          ...
          "opcions": ["generen menys accessos a disc", "tenen menys files", "tenen menys atributs", "ocupen menys espai", "generen menys contenció"],
          "correcta": 4
      },
      {
      ...
      {
          "pregunta": "Només tenint en compte les diferentes possibilitats d'agregació, el nombre de potencials vistes materialitzades que podem crear ja és exponencial.",
          "opcions": ["Cert", "Fals"],
          "correcta": 0
      },
      {
 ...
 tema7: [
    {
        "pregunta": "El disseny físic tracta d'adaptar l'esquema lògic a les particularitats d'un SGBD i una càrrega de treball (workload) concretes.",
        "opcions": ["Cert", "Fals"],
        "correcta": 0
    },
    {
    ...
    },
    {
        ...
        "opcions": ["Conté la informació del sistema que el propi SGBD necessita per funcionar", "La seva estructura i continguts difereixen d'un SGBD a un altre, tot i que existeix un conjunt de vistes standard", "Conté totes les modificacions (insercions, modificacions i esborrats) realitzades des de l'última còpia de seguretat", "És útil per gestionar i afinar el funcionament de la base de dades"],
        "correcta": 2
    },
    {//272
        "pregunta": "Quin dels següents continguts del catàleg NO considerem estàtic?",
        "opcions": ["Informació de les vistes, com ara el seu nom, o la consulta associada", "Informació dels usuaris, com ara els intents de connexió", "Informació de les taules, com ara el seu nom, atributs, o restriccions d'integritat", "Informació dels índexs, com ara el seu nom, tipus, o atributs implicats", "Paràmetres del sistema, com ara la grandària del pool de buffers o la grandària de pàgina"],
        "correcta": 1
    },
    {
        "pregunta": "Quin dels següents continguts del catàleg NO considerem dinàmic?",
        "opcions": ["Informació de les taules, com ara la seva cardinalitat o el nombre de blocs", "Informació dels usuaris, com ara els intents de connexió", "Informació de les vistes, com ara si estan materialitzades o es poden expandir", "Informació dels índexs, com ara la seva alçada o el rang de valors"],
        "correcta": 2
    },
    {//274
    ...
    {
        "pregunta": "L'estàndard SQL'03 distingeix entre la informació del catàleg necessària per l'administrador i la necessària pels usuaris de la base dades.",
        "opcions": ["Cert", "Fals"],
        "correcta": 0
    },
    {//276
    ...
    {
        "pregunta": "Index-only query answering vol dir que el SGBD no accedirà la taula corresponent per a resoldre la consulta.",
        "opcions": ["Cert", "Fals"],
        "correcta": 0
    }
],
...
tema9: [
        ...
        {
            "pregunta": "El nombre de vegades que l'algorisme External Merge Sort ha de llegir i escriure la taula es logarítmic respecte a la grandària de la pròpia taula.",
            "opcions": ["Cert", "Fals"],
            "correcta": 0
        },
        {//391
...
tema11:[
        ...
        {
            "pregunta": "Els paràmetres del SGBD serveixen per a configurar el comportament dels seus subsistemes (com ara el gestor de consultes, el planificador, o el gestor de dades).",
            "opcions": ["Cert", "Fals"],
            "correcta": 0
        },
        {
...
document.addEventListener('keydown', function(event) {
  if (event.key === 'Enter') { // Verifica si la tecla presionada es Enter
      document.getElementById('següent-pregunta').click(); // Simula el clic del botón
  }
});
